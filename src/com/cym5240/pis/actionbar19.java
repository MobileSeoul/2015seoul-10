...
public class actionbar19 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.514988, 127.120096);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_18)
        .contentLayout(R.layout.actionbar19);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("위례성길").snippet("서울특별시 송파구 방이2동 18")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154605&page=8";
