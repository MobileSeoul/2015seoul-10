...
public class actionbar21 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.500095, 126.893515);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("대림동").snippet("서울특별시 영등포구 대림3동 646")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154793&page=7";
