...
public class actionbar9 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.526871, 126.945531);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_8)
        .contentLayout(R.layout.actionbar9);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("원효대교").snippet("서울특별시 영등포구 여의도동")).showInfoWindow();
