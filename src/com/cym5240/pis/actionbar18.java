...
public class actionbar18 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.579434, 126.991043);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_17)
        .contentLayout(R.layout.actionbar18);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("창덕궁").snippet("서울특별시 종로구 율곡로 99")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154373&page=9";
