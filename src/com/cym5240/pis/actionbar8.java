...
public class actionbar8 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.515200, 126.940842);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_7)
        .contentLayout(R.layout.actionbar8);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("수산시장").snippet("서울특별시 동작구 노들로 688")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=150555&page=54";
