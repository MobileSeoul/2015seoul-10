...
public class actionbar6 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.509764, 127.102890);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_5)
        .contentLayout(R.layout.actionbar6);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("석촌호수").snippet("서울특별시 송파구 신천동 31")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=151988&page=37";
