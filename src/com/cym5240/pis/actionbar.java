...
public class actionbar extends SherlockActivity {
    ...
    private final String imgSrcLink = "http://cafeptthumb1.phinf.naver.net/20151017_223/yil8853_1445027312054UnF8h_PNG/pij_logo.png?type=w740";
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.580435, 127.007459);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2)
        .contentLayout(R.layout.actionbar);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("낙산공원").snippet("서울특별시 종로구 동숭동 산2-10")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=151618&page=41";
