...
public class actionbar16 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.565695, 126.975463);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_15)
        .contentLayout(R.layout.actionbar16);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("덕수궁 돌담길").snippet("서울특별시 중구 세종대로 99")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154286&page=11";
