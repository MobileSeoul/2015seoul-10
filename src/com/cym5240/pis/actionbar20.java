...
public class actionbar20 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.555262, 126.970453);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_19)
        .contentLayout(R.layout.actionbar20);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("서울역").snippet("서울특별시 용산구 한강대로 405")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154644&page=7";
