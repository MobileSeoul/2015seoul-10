...
public class actionbar7 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.555849, 126.894220);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_6)
        .contentLayout(R.layout.actionbar7);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("성산대교").snippet("서울특별시 마포구 망원2동 294-8")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=151035&page=49";
