...
public class actionbar5 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.580230, 126.985356);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_4)
        .contentLayout(R.layout.actionbar5);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("가회동").snippet("서울특별시 종로구 가회동 206")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=152645&page=29";
