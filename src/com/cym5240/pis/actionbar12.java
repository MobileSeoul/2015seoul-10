...
public class actionbar12 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.566942, 127.010172);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_11)
        .contentLayout(R.layout.actionbar12);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("디자인플라자").snippet("서울특별시 중구 을지로 281")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154217&page=11";
