...
public class actionbar2 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.510090, 127.065318);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_1)
        .contentLayout(R.layout.actionbar2);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("남산타워 야경").snippet("서울특별시 강남구 삼성1동 169-25")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=153345&page=22";
