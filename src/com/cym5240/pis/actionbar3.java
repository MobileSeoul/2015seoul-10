...
public class actionbar3 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.568659, 126.894928);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_2)
        .contentLayout(R.layout.actionbar3);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("서울월드컵경기장").snippet("서울특별시 마포구 성산2동 512-5")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=153128&page=25";
