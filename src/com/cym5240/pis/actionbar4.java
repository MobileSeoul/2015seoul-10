...
public class actionbar4 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.579766, 126.974794);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_3)
        .contentLayout(R.layout.actionbar4);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("경복궁").snippet("서울특별시 종로구 세종로 1-84")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=152968&page=26";
