...
public class actionbar13 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.575105, 126.866665);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_12)
        .contentLayout(R.layout.actionbar13);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("빛내림").snippet("서울특별시 마포구 상암동 496-198")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154222&page=11";
