...
public class actionbar23 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.532281, 126.920238);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_22)
        .contentLayout(R.layout.actionbar23);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("윤중로").snippet("서울특별시 영등포구 여의동 13-26")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154882&page=6";
