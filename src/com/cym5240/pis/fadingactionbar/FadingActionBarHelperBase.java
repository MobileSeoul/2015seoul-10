 ...
 */
package com.cym5240.pis.fadingactionbar;
...
import com.cym5240.pis.fadingactionbar.view.ObservableScrollView;
import com.cym5240.pis.fadingactionbar.view.ObservableWebViewWithHeader;
import com.cym5240.pis.fadingactionbar.view.OnScrollChangedCallback;
...
public abstract class FadingActionBarHelperBase {
    ...
    private OnScrollListener mOnScrollListener = new OnScrollListener() {
  	  ...
  	  {
  	    // ?ïÑ?ù¥?Öú?ùÑ Ï∂îÍ??ïò?äî ?èô?ïà Ï§ëÎ≥µ ?öîÏ≤??ùÑ Î∞©Ï??ïòÍ∏? ?úÑ?ï¥ ?ùΩ?ùÑ Í±∏Ïñ¥?ë°?ãà?ã§.
  	    mLockListView = true;
  	    ...
  	    //	getDocList(String.valueOf(size));
  	        ...
  	        // Î™®Îì† ?ç∞?ù¥?Ñ∞Î•? Î°úÎìú?ïò?ó¨ ?†Å?ö©?ïò???ã§Î©? ?ñ¥?åë?Ñ∞?óê ?ïåÎ¶¨Í≥†
  	        // Î¶¨Ïä§?ä∏Î∑∞Ïùò ?ùΩ?ùÑ ?ï¥?†ú?ï©?ãà?ã§.
  	     //   m_adapter.notifyDataSetChanged();
  	        mLockListView = false;
  	      }
  	    };
  	    
  	    // ?Üç?èÑ?ùò ?îú?†à?ù¥Î•? Íµ¨ÌòÑ?ïòÍ∏? ?úÑ?ïú ÍººÏàò
