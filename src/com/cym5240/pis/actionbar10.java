...
public class actionbar10 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.554707, 126.984221);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_9)
        .contentLayout(R.layout.actionbar10);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("회현동").snippet("서울특별시 중구 회현동1가 산1-31")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154115&page=13";
