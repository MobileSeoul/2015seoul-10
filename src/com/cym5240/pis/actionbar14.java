...
public class actionbar14 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.575526, 126.976920);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_13)
        .contentLayout(R.layout.actionbar14);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("연등축제").snippet("서울특별시 종로구 세종로 47-2")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154233&page=11";
