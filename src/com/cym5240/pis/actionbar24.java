...
public class actionbar24 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.557560, 126.976754);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_23)
        .contentLayout(R.layout.actionbar24);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("남산육교").snippet("서울특별시 중구 남창동 236-2")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154948&page=5";
