...
public class actionbar11 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.569793, 127.001987);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_10)
        .contentLayout(R.layout.actionbar11);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("청계천").snippet("서울특별시 종로구 종로5가 398-6")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154200&page=12";
