...
public class actionbar15 extends SherlockActivity {
	...
	/* 파싱 */
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.568954, 126.982583);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       //setTheme(SampleList.THEME); //Used for theme switching in samples
        ...
        .headerLayout(R.layout.header2_14)
        .contentLayout(R.layout.actionbar15);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("청계천").snippet("서울특별시 종로구 서린동 1-9")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=154281&page=11";
